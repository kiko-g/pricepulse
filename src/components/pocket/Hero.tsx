...
function PlayIcon(props: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <circle cx="12" cy="12" r="11.5" className="stroke-gray-400 dark:stroke-gray-100" />
      <path
        d="M9.5 14.382V9.618a.5.5 0 0 1 .724-.447l4.764 2.382a.5.5 0 0 1 0 .894l-4.764 2.382a.5.5 0 0 1-.724-.447Z"
        className="fill-gray-400 stroke-gray-400 dark:fill-gray-100 dark:stroke-gray-100"
      />
    </svg>
  )
}
      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="dark:text-gray-499 mt-6 text-lg text-gray-600 dark:text-gray-300">
          ...
          <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
            ...
            >
              {brands.map((item, itemIdx) => (
                <li key={`${item.name}-${itemIdx}`} className={clsx("flex", item.className)}>
                  <item.logo />
                </li>
              ))}
            </ul>
